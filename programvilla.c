...
//=======================================================================//
//*****          Fungsi Untuk Login / Masuk Pengunjung             ******//
//=======================================================================//
...
// Input Argumen  : pesanvl.id_pesan, pesanvl.nama_pemesan, pesanvl.noHP //
//                  pesanvl.email, pesanvl.orang, hari1, pesanvl.tglCI,  //
//                  pesanvl.blnCI, pesanvl.thnCI, pesanvl.DPpemesan      //
...
//=======================================================================//
//****     Fungsi Untuk Menyeleksi Tanggal Pada Bulan Februari      *****//
//=======================================================================//
// Nama Fungsi    : Februari                                             //
// Pasiing Argumen: int thn                                              //
// Input Argumen  : -                                                    //
// Output Argumen : -                                                    //
// Deskripsi      : Fungsi ini berfungsi untuk menyeleksi tanggal pada   //
//                  bulan Februari                                       //
// Versi : 1.0                                      Rev. 0               //
// Tgl   : 13-12-2021                               Tgl: -               //
// Gusti Ayu Wahyu Whurapsari - 2105551042                               //
...
//=======================================================================//
//**** Fungsi Untuk Menyeleksi Tanggal Pada Bulan yang Bukan Februari****//
//=======================================================================//
// Nama Fungsi    : Februari                                             //
...
//=======================================================================//
//*****   Fungsi Untuk Mengecek Nomor Villa Saat Menghapus Data     *****//
//=======================================================================//
// Nama Fungsi    : checkNomor                                           //
// Passing Argumen: struct pesan_villa pesanvl, int id                   //
// Input Argumen  : -                                                    //
// Output Argumen : -                                                    //
// Deskripsi      : Fungsi ini berfungsi untuk menyeleksi atau mengecek  //
//                  jika nomor villa yang akan dihapus ada pada database //
//                  yang telah dibuat                                    //
// Versi : 1.0                                      Rev. 0               //
// Tgl   : 13-12-2021                               Tgl: -               //
// Putu Eternalie Prajnani Welaga - 2105551046                           //
...
void hapusdtpesan (pesan_villa pesanvl, int r){
	...
	int s; //deklarasi variabel s ke dalam tipe data integer
...
// Versi : 1.0                                      Rev. 1               //
// Tgl   : 10-12-2020                               Tgl: 24/12/2021      //
// Revisi 1 : Menambahkan menu untuk melihat aturan pemesanan vila agar  //
//            memudahkan pengunjung ketika ingin memesan villa           //
// Gusti Ayu Wahyu Whurapsari - 2105551042                               //
// Kelas B                                                               //
//=======================================================================//
...
//=======================================================================//
void lokasi_villa (){
	int pilih1 ; //deklarasi variabel pilih1 ke dalam tipe data integer yang digunakan dalam fungsi lokasi_villa
	system ("cls");
    printf ("\n");
    printf ("\t\t\t\t\t|============================================================|\n");
    printf ("\t\t\t\t\t|                          LOKASI VILLA                      |\n");
    ...
    printf ("\t\t\t\t\t| Tekan      : ") ;
	scanf  ("%d", &pilih1);
	if (pilih1== 1) //jika menekan 1 akan diarahkan pada menu pengunjung
		menu_pengunjung ();
	else  //jika menekan selain 1 maka user akan diminta memasukkan atau mengetik ulang 1
		printf ("\t\t\t\t\t| Silahkan ketik ulang 1 \n"); 
		goto tekan1 ;
...
// Output Argumen : -                                                    //
// Deskripsi      : Fungsi ini digunakan untuk menampilkan cara pesan    //
//                  villa bagi yang dapat diakses oleh pengunjung        //
// Versi : 1.0                                      Rev. 0               //
// Tgl   : 10-12-2020                               Tgl: -               //
// Gusti Ayu Wahyu Whurapsari - 2105551042                               //
// Kelas B                                                               //
